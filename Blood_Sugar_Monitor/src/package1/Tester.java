...
public class Tester {
    ...
    public static void main(String[] args) {
        System.out.println("Welcome To Blood_Sugar_Monitor ");
    ...
    public static void displayMenu() {
        System.out.println("Create a New Record   (1)");
        System.out.println("Show All Users Records(2)");
        System.out.println("View User's Records   (3)");
        System.out.println("delete All Records    (4)");
